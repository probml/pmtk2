...
testModel = LinDynSys('-ndimsLatent',stateSize); % at a minimum, we must specify the dimensionality of the hidden states.
testModel = fit(testModel,DataSequence(Y));
